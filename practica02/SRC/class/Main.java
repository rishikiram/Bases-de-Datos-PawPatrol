...
public class Main {
    ...
    public static void main(String... args) throws IOException {
        Tabla viveros = new TablaViveros(new File("src/db/viveros.csv"));
        Tabla empleados = new TablaEmpleados(new File("src/db/empleados.csv"));
        Tabla plantas = new TablaPlantas(new File("src/db/plantas.csv"));
